      ...
      <div className="p-5 max-w-md mx-auto space-y-4">
          ...
          <div className="mt-8 pt-6 border-t border-dashed border-stone-200">
             {!aiAnalysis && !isAnalyzing && (
               <button 
                ...
                className="w-full py-3.5 bg-stone-900 text-[#bef264] rounded-2xl shadow-lg shadow-stone-900/20 flex items-center justify-center space-x-2 active:scale-[0.98] transition-transform"
               >
                 <Sparkles size={18} />
           ...
           <div className="bg-[#bef264] text-stone-900 p-6 rounded-[2rem] shadow-xl shadow-lime-100 mt-4 relative overflow-hidden">
             ...
             <div className="flex items-start justify-between relative z-10">
               <div>
                 ...
                 <p className="text-stone-900/70 text-sm mt-2 max-w-[90%] leading-relaxed font-medium">
                   将三甲方案同步至家门口社区医院。
                 </p>
               </div>
             ...
             <button 
               ...
               className="mt-6 w-full py-3.5 bg-stone-900 text-white font-bold rounded-xl text-sm hover:bg-stone-800 transition-colors shadow-sm"
             >
               立即办理转档
             </button>
           </div>
        ...
        {transferStep === 1 && (
          <div className="bg-white p-6 rounded-[2rem] shadow-xl border border-[#bef264] animate-in slide-in-from-bottom-10 duration-500">
             <h3 className="font-bold text-lg text-stone-950 mb-6 text-center">确认转档信息</h3>
             ...
             <div className="space-y-4 mb-8 bg-[#F2F5E8] p-4 rounded-2xl">
                ...
                <div className="flex justify-between text-sm items-center border-b border-stone-200 pb-3">
                  ...
                  <span className="font-bold text-stone-800 text-right">
                    ...
                    <div className="text-[10px] bg-[#bef264] text-stone-950 inline-block px-1 rounded ml-1">距离最近</div>
                  </span>
                </div>
        ...
        {transferStep === 2 && (
          <div className="bg-[#bef264] p-8 rounded-[2rem] flex flex-col items-center text-center animate-in zoom-in duration-300">
            ...
            <h3 className="font-black text-2xl text-stone-950 mb-2">转档成功!</h3>
            <p className="text-stone-900 font-medium text-sm mb-8 leading-relaxed">
              瑞金医院治疗方案已同步。<br/>
              现在可预约社区医院注射服务。
            </p>
            <button 
  ...
  return (
    <div className="p-5 max-w-md mx-auto space-y-6">
      <header className="pt-2">
        <h1 className="text-2xl font-black text-stone-950">我的健康档案</h1>
        ...
        {MOCK_RECORDS.map(record => (
          ...
          >
            <div className="flex items-start space-x-4">
              <div className={`w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 transition-colors ${record.hospitalName.includes('瑞金') ? 'bg-stone-900 text-[#bef264]' : 'bg-[#F2F5E8] text-stone-600'}`}>
                <FileText size={24} strokeWidth={2.5} />
              </div>
              <div>
                <h3 className="font-bold text-stone-950 text-lg">{record.diagnosis}</h3>
