...
import { ShieldCheck, MessageCircle, CreditCard, User, AlertTriangle, FileText, Eye, Stethoscope, Users, Lock, ChevronRight, Building2, Activity } from 'lucide-react';
  ...
  if (step === 'PROCESSING') {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-8 text-center space-y-6">
         <div className="w-16 h-16 border-4 border-stone-800 border-t-[#bef264] rounded-full animate-spin mb-6"></div>
         <div>
